...
const AddStackCard = ({ tech,addToStack,setAddToStack }: AddStackCardProps) => {
    ...
    return (
        ...
        <div className="flex items-center gap-3">
          <img className='h-7 w-7 object-contain' src={tech.image} alt="tech-img" />
          <div>
        ...
        <button className="text-red-600 cursor-pointer" onClick={()=>handelSingleRemove(tech)}>X</button>
        </div>
        </>
    )
}
